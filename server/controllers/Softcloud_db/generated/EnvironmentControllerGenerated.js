 ...
 * 
 *  TO CUSTOMIZE EnvironmentControllerGenerated.js PLEASE EDIT ../EnvironmentController.js
 * 
 *  -- THIS FILE WILL BE OVERWRITTEN ON THE NEXT SKAFFOLDER'S CODE GENERATION --
 * 
 */
import Properties from "../../../properties";
import EnvironmentModel from "../../../models/Softcloud_db/EnvironmentModel";
...
const generatedControllers = {
  ...
  */
  create: async (req, res) => {
    try {
      const result = await EnvironmentModel.create(req.body);
      res.json(result);
    } catch (err) {
  ...
  */
  delete: async (req, res) => {
    try {
      const result = await EnvironmentModel.delete(req.params.id);
      res.json(result);
    } catch (err) {
      const safeErr = ErrorManager.getSafeError(err);
      res.status(safeErr.status).json(safeErr);
  ...
  */
  get: async (req, res) => {
    try {
      const result = await EnvironmentModel.get(req.params.id);
      res.json(result);
    } catch (err) {
      const safeErr = ErrorManager.getSafeError(err);
      res.status(safeErr.status).json(safeErr);
  ...
  /**
  * EnvironmentModel.list
  *   @description CRUD ACTION list
  *
  */
  list: async (req, res) => {
    try {
      const result = await EnvironmentModel.list();
      res.json(result);
    } catch (err) {
      const safeErr = ErrorManager.getSafeError(err);
      res.status(safeErr.status).json(safeErr);
  ...
  */
  update: async (req, res) => {
    try {
      const result = await EnvironmentModel.update(req.body);
      res.json(result);
    } catch (err) {
      const safeErr = ErrorManager.getSafeError(err);
      res.status(safeErr.status).json(safeErr);
