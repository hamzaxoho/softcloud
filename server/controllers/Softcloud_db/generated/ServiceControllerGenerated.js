 ...
 * 
 *  TO CUSTOMIZE ServiceControllerGenerated.js PLEASE EDIT ../ServiceController.js
 * 
...
const generatedControllers = {
   ...
   */
  init: router => {
    const baseUrl = `${Properties.api}/service`;
  ...
  */
  get: async (req, res) => {
    try {
      const result = await ServiceModel.get(req.params.id);
      res.json(result);
    } catch (err) {
      const safeErr = ErrorManager.getSafeError(err);
      res.status(safeErr.status).json(safeErr);
  ...
  */
  list: async (req, res) => {
    try {
      const result = await ServiceModel.list();
      res.json(result);
    } catch (err) {
      const safeErr = ErrorManager.getSafeError(err);
      res.status(safeErr.status).json(safeErr);
  ...
  */
  update: async (req, res) => {
    try {
      const result = await ServiceModel.update(req.body);
      res.json(result);
    } catch (err) {
      const safeErr = ErrorManager.getSafeError(err);
      res.status(safeErr.status).json(safeErr);
