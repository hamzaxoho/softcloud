...
class Database {
  ...
  async init() {
    ...
    Logger.info("MongoDB connected at: " + properties.softcloud_db_dbUrl);
 ...
 // End Init Models
  ...
  async authenticate() {
    ...
    try {
      this.dbConnection_softcloud_db = await mongoose.connect(
        "mongodb://" + properties.softcloud_db_dbUrl,
   ...
   */
  getConnection() {
    return this.dbConnection_softcloud_db;
  }
}
