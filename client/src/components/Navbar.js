    ...
    const sideList = (
      <div className={classes.list}>
        <div className="navbar-drawer-header">
          ...
          <div className="navbar-drawer-text">softcloud</div>
        </div>
        <Divider />
        <List>
          {/* START LINK MENU */}
           ...
           <Link to="/containers">
            <ListItem button key="Container">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="Container" />
            </ListItem>
          </Link>{" "}            
           <Link to="/environments">
            <ListItem button key="Environment">
              <ListItemIcon>
                <ArrowForwardIos />
              </ListItemIcon>
              <ListItemText className="menu-text" primary="Environment" />
            </ListItem>
          </Link>{" "}            
           <Link to="/projects">
           ...
           <Link to="/services">
            <ListItem button key="Service">
              ...
              <ListItemText className="menu-text" primary="Service" />
            </ListItem>
          </Link>{" "}            
           <Link to="/users">
           ...
           <Link to="/volumes">
            <ListItem button key="Volume">
              ...
              <ListItemText className="menu-text" primary="Volume" />
            </ListItem>
          </Link>{" "} {/* END LINK MENU */}
        </List>
      </div>
